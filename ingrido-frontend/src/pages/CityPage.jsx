...
const CityPage = () => {
  ...
  const cities = [
    { id: 1, name: 'Karachi', dishes: '50+', region: 'Sindh', selected: 120, img: '/assets/Karachi.jpeg', tagline: 'diverse local dishes and the best places to eat' },
    { id: 2, name: 'Lahore', dishes: '45+', region: 'Punjab', selected: 150, img: '/assets/Lahore.jpeg', tagline: 'rich traditional dishes and iconic food spots' },
    { id: 3, name: 'Islamabad', dishes: '25+', region: 'Capital Territory', selected: 90, img: '/assets/Islamabad.jpeg', tagline: 'modern local cuisine and top dining places' },
    { id: 4, name: 'Peshawar', dishes: '30+', region: 'KPK', selected: 110, img: '/assets/Peshawar.jpeg', tagline: 'traditional Pashtun dishes and authentic eateries' },
    { id: 5, name: 'Quetta', dishes: '20+', region: 'Balochistan', selected: 80, img: '/assets/Quetta.jpeg', tagline: 'hearty regional dishes and popular food spots' },
    { id: 6, name: 'Multan', dishes: '18+', region: 'Punjab', selected: 100, img: '/assets/Multan.jpeg', tagline: 'traditional southern dishes and local dining places' },
    { id: 7, name: 'Faisalabad', dishes: '22+', region: 'Punjab', selected: 95, img: '/assets/Faisalabad.jpeg', tagline: 'flavorful local dishes and well-known food spots' },
    { id: 8, name: 'Sialkot', dishes: '15+', region: 'Punjab', selected: 75, img: '/assets/Sialkot.jpeg', tagline: 'classic local dishes and trusted food spots' },
    { id: 9, name: 'Hyderabad', dishes: '20+', region: 'Sindh', selected: 85, img: '/assets/Hyderabad.jpeg', tagline: 'rich Sindhi dishes and popular food destinations' },
    { id: 10, name: 'Skardu', dishes: '12+', region: 'Gilgit-Baltistan', selected: 130, img: '/assets/Skardu.jpeg', tagline: 'unique mountain cuisine and scenic eateries' },
  ];

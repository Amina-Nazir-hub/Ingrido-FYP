...
import { HERO_IMAGE, DEMO_VIDEO_URL } from "../constants";
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            ...
            <HeroButtons onWatchDemo={() => setIsVideoModalOpen(true)} />
          </div>
        </div>
...
const HeroButtons = ({ onWatchDemo }) => (
  <div className="flex flex-wrap gap-4 mb-12 animate-fade-up [animation-delay:0.3s]">
    ...
    <button 
      onClick={onWatchDemo}
      className="inline-flex items-center justify-center bg-background text-foreground hover:bg-background/30 hover:text-foreground hover:underline font-semibold transition-all duration-300 h-14 rounded-xl px-10 text-lg cursor-pointer"
    >
      Watch Demo
    </button>
  </div>

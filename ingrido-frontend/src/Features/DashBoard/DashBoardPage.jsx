          ...
          {(localRecommended.length > 0 || recommendedCards.length > 0) && (
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="p-2 rounded-full bg-primary hover:text-background transition-colors cursor-pointer disabled:opacity-50"
                title="Refresh Recommendations"
              >
                <RefreshCw
                  className={`h-5 w-5 text-primary-foreground hover:text-background transition ${
